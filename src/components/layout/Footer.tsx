  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.footerSource}><span>Start with a question</span><h2>Find the right next step</h2><p>Browse the roster, compare a short list, or open a guide for the decision in front of you.</p><Link href="/guides">Read the guides →</Link></div>
      </div>
