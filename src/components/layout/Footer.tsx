  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.footerGrid}`}>
        <div className={styles.footerBrand}><Brand compact /><p>Find Aniimo, plan a team and choose a route with fewer loose ends.</p></div>
